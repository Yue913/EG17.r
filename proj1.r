...
paste(cat, sep=" ") ## shows the final 50-words section.
...
paste(text_comparison, sep=" ") ## shows the final 50-words section.
...
paste(cat_after_cap, sep=" ") ## shows the final 50 words section after updating.
